// don't polute the global context; contain in a function;
// Buget Controller
	...
	*/
	...
	return {
		addItem(type, des, val) {
			// capitalized variables denote constants. ID is not a constant, call it id;
			let newItem, ID;
...
let controller = ((budgetCtrl, UICtrl) => {
	// no need for this to be inside the controller function
...
// need a teardown flow ie remove listeners from the DOM, etc

// should happen on document.ready so as not to encounter race conditions
controller.init();
